    ...
    curl -X POST https://api.engine.usesophic.com/onboarding-applications \
      ...
      -d '{
        ...
        "consents": [
          ...
          {"person": "per_abc123", "consent_type": "data_accuracy",     "legal_document_version": "legal_doc_ver_data_v1", "consented_at": "2026-04-18T09:30:00Z"}
        ],
        "evidence": [
...
<Note>
Each consent needs a `legal_document_version`. Discover valid IDs via the [legal document versions endpoint](/api-reference/list-versions-of-a-legal-document).
</Note>
