...
<Steps>
  ...
  <Step title="Wait for compliance review">
    You'll get `status: "pending"`, `outcome: null`. Poll [`GET /onboarding-applications/{id}`](/docs/onboarding/applications#retrieving-an-application) for updates — the customer and accounts appear once compliance approves.
  </Step>
</Steps>
