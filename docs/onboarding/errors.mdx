...
| `Consent '...' references unknown legal_document_version:...` | The referenced version doesn't exist. | Fetch valid versions via [`GET /legal-documents/{legal_document_id}/versions`](/api-reference/legal-documents/list-versions-of-a-legal-document). |
