...
**Required claims (every relationship type)** — the full natural-person KYC set, identical to what a natural owner or signatory supplies: `identity`, `nationalities`, `residence`, `tax_residencies`, `fatca_status`, `pep_status`, `employment`, `financial_profile`, `investment_experience`, `expected_activity`.
...
<Note>
Post-submission transitions happen in our compliance systems. Poll the application for updates.
</Note>
