...
In the sandbox environment, you can trigger predefined execution outcomes (cancel, partial fill, full fill) using specific `cash_amount` or `quantity` values. See [Sandbox scenarios](/docs/orders/sandbox-scenarios).
</Tip>
