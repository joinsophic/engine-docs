...
<Update label="July 27, 2026" description="additions">
  ...
  **Added**
  - [List permissions](/api-reference/identity/list-permissions) to retrieve effective permissions for the authenticated actor, including scope and conditional details.
