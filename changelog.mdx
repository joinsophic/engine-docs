...
<Update label="July 29, 2026" description="additions">
  ## Enhanced ETF instrument details

  ETF instrument responses now include fund-specific metadata like display names,
  headlines, and currency information to help you surface richer product details.

  **Added**
  - `display_name` on ETF instruments: a short headline derived from the legal name with share-class tokens removed.
  - `headline` on ETF instruments: a one-line "what do I own" summary shown on the holding card.
  - `currency_sentence` on ETF instruments: plain-language description of the fund's currency risk.
  - `fund_base_currency` on ETF instruments: the currency in which the fund's net assets are reported.
