...
<Update label="July 22, 2026" description="additions">
  ...
  **Added**
  ...
  - [List effective permissions](/api-reference/identity/list-effective-permissions) to see your actor's permissions in the current realm, including conditional ones.
  - `icon_url` (nullable) on instrument responses for easy access to the asset's icon.
