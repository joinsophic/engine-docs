...
<Update label="July 23, 2026" description="additions">
  ## Permissions and instrument icons

  You can now retrieve your effective permissions, and instruments carry public icon URLs.

  **Added**
  - [List my permissions](/api-reference/customers/list-my-permissions) endpoint to see your effective permissions within your current tenant.
  - `icon_url` field on all instrument responses: Equity, Future, Bond, Cryptocurrency, Forex, and Fund. We return a public CDN URL for each instrument's icon.
  - Error code `duplicate_tenant` when you create a tenant with a name that already exists.
</Update>
