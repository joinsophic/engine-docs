...
<Update label="July 22, 2026" description="additions">
  ...
  **Added**
  ...
  - `icon_url` field (optional string, public CDN URL) on all instrument responses.
  - `GET /me/permissions` endpoint to list your effective permissions in the current realm. Returns scopes and conditional permission ids when applicable.
  - `duplicate_tenant` error code when creating a tenant with a name that already exists.
</Update>
