...
<Update label="July 21, 2026" description="additions">
  ...
  Instrument responses now include a publicly available CDN URL for each
  instrument's icon, so you can display branded visuals in your UI.

  **Added**
  - `icon_url` field on all instrument responses (nullable string).
</Update>
