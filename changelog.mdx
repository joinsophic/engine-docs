...
<Update label="July 27, 2026" description="additions">
  ## Instrument icons and tenant name conflicts

  Instrument responses now include an icon URL for display, and we report a new
  error code when you create a duplicate tenant.

  **Added**
  - `icon_url` on instrument responses for displaying a public CDN icon of the instrument.
  - Error code `duplicate_tenant` when attempting to create a tenant with a name
    that already exists.
</Update>
