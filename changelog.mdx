...
<Update label="July 22, 2026" description="additions">
  ...
  **Added**
  ...
  - `icon_url` field on all instrument responses (stocks, bonds, ETFs, and others).
    A nullable string containing a public CDN URL to the instrument's icon, useful
    for displaying icons in your UI.
</Update>
