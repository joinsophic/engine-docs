...
<Update label="July 20, 2026" description="additions">
  ...
  We now include a CDN URL for each instrument's icon, so you can display visual representations without storing icon assets yourself.

  **Added**
  - `icon_url` on instrument responses (optional, nullable string).
</Update>
