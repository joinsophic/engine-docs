...
<Update label="July 20, 2026" description="additions">
  ## Instrument icons

  Instrument responses now include a CDN URL for the instrument's icon, so you can
  display branded visuals without needing a separate image lookup.

  **Added**
  - `icon_url` on instrument responses. This is a public CDN URL you can use directly in your UI.
</Update>
