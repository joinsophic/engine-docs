...
<Update label="July 21, 2026" description="additions">
  ## Instrument icons now available

  All instrument responses now include an optional `icon_url` field with a public CDN image URL.
  You can use this to display instrument-branded icons in your UI without hosting assets yourself.

  **Added**
  - `icon_url` on all instrument types ([Retrieve an instrument](/api-reference/catalog/retrieve-an-instrument)). This nullable string field contains the public CDN URL of the instrument's icon.
</Update>
